...
<html lang="ru-RU">
<head>
    <title>Новости - Танки Онлайн — бесплатная браузерная онлайн игра</title>
    <meta name="description" content="Новости - Танки Онлайн — бесплатная браузерная онлайн игра"/>
    <meta charset="UTF-8"/>
    ...
    <script type="text/javascript">
        ...
        window._wpemojiSettings = {
            ...
            "svgExt": ".svg",
            "source": {"concatemoji": "https:\/\/tankionline.com\/ru\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.5.4"}
        };
    ...
    <style id='global-styles-inline-css' type='text/css'>
        body {
            ...
            --wp--preset--color--green: #00EC08;
            --wp--preset--color--yellow: #FFCC00;
            --wp--preset--color--muted: #BFD5FF;
            --wp--preset--color--blue: #00D4FF;
            --wp--preset--color--discount: #FFEE00;
            --wp--preset--color--red: #FF6666;
            --wp--preset--color--alert: #FF3333;
            --wp--preset--color--brand-green: #76FF33;
    ...
    <meta name="current-time" content="2024-08-17 19:26:33"/>
...
<body class="ru">
<script>
    const ajaxurl = 'http://landing/wp-admin/admin-ajax.php';
</script>


<!--<link rel="stylesheet" href="https://tankionline.com/ru/wp-content/themes/tanki2023/resources/css/news-list.css?ver=147" type="text/css">-->
/**
* script
**/
<div class="search-wrapper">
    <a class="open-search" href="#search-modal" rel="modal:open">
        <div class="search">Найти новость</div>
    </a>
</div>
<h1 class="title hidden-title">Новости</h1>
<section class="news-list">
    <div class="news-list-wrapper">
        ...
        $articles->the_post(); ?>
        <?php
        $data_youtube = get_post_custom(get_the_ID());

        if (!empty($data_youtube['dataYoutubeId'][0]) || !empty($data_youtube ['youtubeImageSrc'][0])) {

            $data_youtube_id = $data_youtube['dataYoutubeId'][0];
            $youtube_image_src = $data_youtube['youtubeImageSrc'][0];
        } else {
            $data_youtube_id = null;
        }
        ...
        foreach ($posttags as $value) {
            if (mb_strtolower($value->name) === 'video') {
                $flag = true;
            }
        }
        if ($flag){
        ?>
        <a href="<?php the_permalink(); ?>" class="news-card video-card open-video"
           data-video="<?php echo $data_youtube_id; ?>" draggable="false">
            <div class="image">
                <div class="filler"></div>
                <div class="image-wrapper image-loader">
                    <img src="<?php echo $youtube_image_src; ?>" alt="" width="100">
                    <div class="loader">
            ...
            <div class="info">
                <div class="date"><?php echo get_the_date('n F, Y', get_the_ID()); ?></div>
                <?php
                $posttags = get_the_tags();
                if ($posttags) {
...
<div class="popup search-popup">
    ...
    <div id="search-modal" class="modal content">
        <div class="container">
            ...
            <div class="container-search-modal">
                ...
                <div class="search-modal-filter type-anonce-filter">Тип анонса:
                    ...
                    <span data-filter="event">Событие</span>
                    <span data-filter="video">Видео</span>
                    <span data-filter="general">Общее</span>
                    <span data-filter="common-questions">FAQ</span>
                </div>
            </div>
    ...
    <div class="main-block">
        <div class="text approval chosen">
            ...
            <div class="text-approval">
                Мы используем cookie-файлы для аутентификации, обеспечения вашей безопасности, учета ваших предпочтений,
                маркетинга, анализа производительности и аналитики. Мы также обмениваемся информацией об использовании
                вами наших сайтов с партнерам по маркетингу и аналитике. Наши партнеры могут объединять полученные
                данные с другой имеющейся у них информацией.
            </div>
        </div>
        <div class="text details">
            <div class="details-option">
                ...
                <div class="info-text">
                    <div class="text-approval">
                        Если вы авторизовались на наших ресурсах, cookie-файлы помогают нам показать вам правильную
                        информацию и персонализировать ваш опыт.
                    </div>
            ...
            <div class="details-option">
                ...
                <div class="info-text">
                    <div class="text-approval">
                        Мы используем cookie-файлы для включения и поддержки наших функций безопасности и для того,
                        чтобы помочь нам обнаружить вредоносную активность.
                    </div>
                    <div class="details-settings">
                        Подробнее
                        <div class="arrow-details"></div>
            ...
            <div class="details-option">
                ...
                <div class="info-text">
                    <div class="text-approval">
                        Cookie-файлы или аналогичные технологии могут указать нам, какой язык вы предпочитаете и каковы
                        ваши предпочтения в отношении коммуникаций. Они помогут вам легче заполнить формы на наших
                        ресурсах. Они также предоставляют вам функционал и персонифицированные настройки.
                    </div>
                    <div class="details-settings">
                        Настроить
                        <div class="arrow-details"></div>
                ...
                <table class="info-table">
                    ...
                    <tr>
                        <td>TNK_Flash</td>
                        <td>Сбор, запись, систематизация, накопление, хранение, (обновление, изменение), использование,
                            передача, удаление
                        </td>
            ...
            <div class="details-option">
                ...
                <div class="info-text">
                    <div class="text-approval">
                        Мы можем использовать cookie-файлы или аналогичные технологии, для осуществления маркетинговых
                        кампаний и отслеживания их эффективности. Аналогичным образом наши партнеры могут использовать
                        cookie-файлы, чтобы предоставить нам информацию о ваших взаимодействиях с их услугами и тегами
                        действий для измерения эффективности рекламы и обеспечения более эффективной адресной рекламы,
                        использование этих сторонних cookie-файлов будет подчиняться политикам конфиденциальности
            ...
            <div class="details-option">
                ...
                <div class="info-text">
                    <div class="text-approval">
                        Cookie-файлы или похожие технологии помогают нам узнать, насколько хорошо работают наши ресурсы
                        и Игры. Мы также можем использовать cookie-файлы или подобные технологии для понимания,
                        улучшения и исследования продуктов, функций и сервисов, в том числе для создания логов и записей
                        при осуществлении доступа к нашим сайтам и ресурсам с разных устройств, таких как ваш компьютер
        ...
        <div class="text info">
            <div class="text-approval">
                Мы - ООО “Альтернатива Гейм”, 614081, Пермь, Кронштадтская 10, а/я 15 (Оператор персональных
                данных).<br>
                Наши партнеры по маркетингу и аналитике: ООО «Яндекс» (Россия).
                Перечень персональных данных, на обработку которых дается согласие субъекта, зависит от вашего выбора в
                разделе <span class="more-info">Подробности</span>.<br>
                Ваше согласие распространяется на следующие домены: tankionline.com, help.tankionline.com,
                tankiforum.com<br>
                ...
                Перед принятием согласия ознакомьтесь с нашей <a href="https://tankionline.com/ru/privacy/">Политикой
...
<div class="popup support-form">
    ...
    <div class="content">
        ...
        <form class="support-form">
            ...
            <div class="success">
                <div class="image"></div>
                <div class="text">Твой запрос в поддержку принят. Служба поддержки свяжется с тобой в ближайшее время.
                </div>
            </div>
        </form>
    </div>
...
<script src="https://www.google.com/recaptcha/api.js?onload=CaptchaCallback&render=explicit&hl=ru_RU" async
        defer></script>
<div class="popup video-popup video">
    ...
    <div class="content">
        <div class="close-icon close-popup"></div>
        <div class="filler"></div>
        <iframe src="https://www.youtube-nocookie.com/embed/eJVTo7pPkvI?si=APlLRQGoNtPEk5jQ"
        ...
        <div class="container">
            <div class="container-search-modal">
                <form role="search" method="get" id="searchform" class="searchform"
                      action="https://tankionline.com/ru/">
                    <input autofocus placeholder="Поиск" type="text" value="" name="s" class="search-input-modal"
                           id="s"/>
